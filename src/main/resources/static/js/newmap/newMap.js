...
//		if(options==undefined || options.area==undefined || options.area === 'LOCAL'){
		...
		common.ajax("/newmap/productList",searchData,service.setAllMarker);
	},
	// 물건 정보 전체 리스트 가져오기
//  getProductSearchList: function(searchData) {
//    common.ajax(ctx+"/newmap/getProductList.do",searchData,service.setAllSearch);
//  },
	...
	createData: function(){
		...
		$.ajax({
			...
			success : function(data) {
				...
				common.ajax("/newmap/createProductInfo",searchData,service.createDone);
			}
		});
	},
	...
	removeOverlay:function(){
		...
		daum.maps.event.addListener(map, "click", function(mouseEvent) {
			if (removeEvent) {
				...
				common.ajax("/newmap/removeProductInfo.do",searchData,service.removeDone);
...
//	  });
		...
		common.ajax("/newmap/getProductFileList",searchData,service.modyFileSet);
...
//			  var fileList = document.getElementById(id).files;
		...
		$.ajax({
			...
			success : function(data) {
				...
				common.ajax("/newmap/modifyProductInfo",searchData,service.modifyDone);
			}
		});
